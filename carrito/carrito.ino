...
const int ANGULO_CORRECCION_DERIVA = 20; // grados DERECHA (positivo) antes de cada recta
const int ANGULO_EXTRA_IZQ = 20;          // grados extra en giros a la IZQUIERDA (90 -> 96)
